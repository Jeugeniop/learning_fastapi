...
#             in thedatabase that have a good match""",
#             min_length=3,
#         ),
#     ] = None,
# ):
...
#             alias="item-query",
#             title="Query string",
#             description="""Query string for the items to search in
#             the database that have a good match""",
#             min_length=3,
#             max_length=50,
#             pattern="^fixedquery$",
#             deprecated=True,
...
def check_valid_id(id: str):
    if not id.startswith(("isbn-", "imdb-")):
        raise ValueError('''Invalid ID format,
                         it must start with "isbn-" or "imdb-"''')
    return id
